...
import { IconPlus, IconMinus, IconParking } from '@tabler/icons-react'

export interface IZoomControlsProps {}

const MapControls = ({ children }: { children: ReactNode }) => (
  <div className="flex flex-col overflow-hidden gap-0 5 space-y-1 rounded shadow-lg divide-primary-800 backdrop-blur-sm">
    {children}
  </div>
)
