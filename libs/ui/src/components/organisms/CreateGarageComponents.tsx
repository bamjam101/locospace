import { FormTypeCreateGarage } from '@locospace/forms/src/createGarages'
import { ViewState } from '@locospace/util/types'
import { useWatch, useFormContext, useFieldArray } from 'react-hook-form'
import { MapMarker } from '../organisms/map/MapMarker'
...
export const GarageMapMarker = () => {
  ...
  return (
    <MapMarker
      ...
      draggable
      onDragEnd={({ lngLat }: { lngLat: { lat: number; lng: number } }) => {
